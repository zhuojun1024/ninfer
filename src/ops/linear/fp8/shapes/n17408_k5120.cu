...
namespace {
// TP-2 gate/up shard for the mixed-precision (FP8 row-scale) FFN layers: half the
// intermediate output rows [174160/2 = 17408, 5120]. Uses the generic A16 chunk launcher
// (GEMV at T=1, SIMT up to 11 tokens, A8 beyond) like the other K=5120 shapes.
using Geometry  = Fp8Geometry<17408, 5120>;
...
const Fp8LinearShape kFp8N17408K5120{17408, 5120, launch_fp8_a16_chunks<11, select_a16>,
