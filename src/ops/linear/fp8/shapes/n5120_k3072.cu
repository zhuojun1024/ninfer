...
namespace {
// TP-2 mixer output projections (attention/output and gdn/output) on a shard: half the input
// columns [5120, 6144/2 = 3072]. Uses the generic A16 chunk launcher (GEMV at T=1, SIMT up to 11
// tokens, A8 beyond) like the other TP-2 N=5120 shard shapes.
...
const Fp8LinearShape kFp8N5120K3072{5120, 3072, launch_fp8_a16_chunks<11, select_a16>,
