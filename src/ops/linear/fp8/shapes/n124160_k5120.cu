...
namespace {
// TP-2 lm_head shard: half the vocabulary rows [124160, 5120], same K as the full head. Uses the
// generic A16 chunk launcher (GEMV at T=1, SIMT up to 11 tokens, A8 beyond) like the other
// K=5120 shapes.
using Geometry  = Fp8Geometry<124160, 5120>;
...
const Fp8LinearShape kFp8N124160K5120{124160, 5120, launch_fp8_a16_chunks<11, select_a16>,
