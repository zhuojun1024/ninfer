...
for i in $(seq 1 300); do
  ...
  if [ "$used0" -lt 1500 ] && [ "$used2" -lt 1500 ]; then
...
timeout 240 ./tests/ninfer_qwen3_5_tp2_forward_test --artifact /home/zhuojun/models/qwen3_8_27b_nvfp4.ninfer 2>&1 | tail -30
