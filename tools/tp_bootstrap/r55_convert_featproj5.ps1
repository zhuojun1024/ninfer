...
$out = 'D:/LLM/qwen3_8_27b_w4a4_w8a8_dflash2_featproj5.ninfer'
...
python -m tools.convert `
  ...
  --proposal `
  --override 'tools/tp_bootstrap/r55_draft_feature_proj_override.py' `
  --name 'qwen3.8-27b-w4a4-w8a8-draftfeatproj5' `
  --device cpu `
  --out $out
$code = $LASTEXITCODE
