...
the repository root. Two PLAN.md snapshots are archived verbatim below under their own
`PLAN.md archive` headers: the 2026-09-21 upstream cherry-pick re-plan and the 2026-09-22
delivery-cleanup rewrite.
